...
const modalStyles = cva(
  'fixed left-2/4 top-1/3 h-auto max-h-[90lvh] min-w-72 max-w-[90lvw] -translate-x-2/4 -translate-y-1/3 rounded-xl border-2 border-gray-300 bg-white px-6 py-4'
);
...
export default function Modal(props: PropsWithChildren<ModalProps>) {
  return ReactDOM.createPortal(
    <Fade in={props.isOpen} mountOnEnter unmountOnExit>
      <div>
        <div className='fixed left-0 top-0 h-full w-full bg-black bg-opacity-60 p-4' />
